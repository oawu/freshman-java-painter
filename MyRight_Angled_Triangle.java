...
public class MyRight_Angled_Triangle extends MyShape{
	public MyRight_Angled_Triangle(){
		this( 0, 0, 0, 0, Color.BLACK,Color.BLACK,Color.BLACK, false ,0);
	}
	public MyRight_Angled_Triangle(  int x1, int y1, int x2, int y2,Color color,Color leftcolor,Color rightcolor, boolean filled ,int big){
	...
	public void draw( Graphics g ){
		...
		if ( super.getisfilled() ){
			...
			g2d.draw( new Line2D.Double( getp3x(), getp3y(), getp1x(), getp1y() ));
		}
		else{
