...
public class MyHexagon extends MyShape{
	...
	public MyHexagon( int x1, int y1, int x2, int y2,Color color,Color leftcolor,Color rightcolor, boolean filled ,int big){
	...
	public int getp2y( ){ return super.gety1( ) + ( super.getheight( ) /2 ) *1 ; }
	public int getp3x( ){ return super.getx1( ) + ( super.getwidth ( ) /3 ) *1 ; }
	public int getp3y( ){ return super.gety2( ) ; }
	public int getp4x( ){ return super.getx1( ) + ( super.getwidth ( ) /3 ) *2 ; }
	public int getp4y( ){ return super.gety2( ) ; }
	public int getp5x( ){ return super.getx2( ) ; }
	public int getp5y( ){ return super.gety1( ) + ( super.getheight( ) /2 ) *1 ; }
	public int getp6x( ){ return super.getx1( ) + ( super.getwidth ( ) /3 ) *2 ; }
	public int getp6y( ){ return super.gety1( ) ; }
	...
	public void draw( Graphics g ){
		...
		if ( super.getisfilled() ){
			...
			g2d.draw( new Line2D.Double( getp6x(), getp6y(), getp1x(), getp1y() ));
		}
		else{
