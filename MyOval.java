...
public class MyOval extends MyShape{
	...
	public MyOval( int x1, int y1, int x2, int y2,Color color,Color leftcolor,Color rightcolor, boolean filled ,int big){
	...
	public void draw( Graphics g ){
		...
		if ( super.getisfilled() ){
			...
			g2d.fill( new Ellipse2D.Double(super.getx1(), super.gety1(),super.getwidth(), super.getheight() ) );
		}
		else{
			g2d.setStroke( new BasicStroke( super.getbig() ) ); 
			g2d.setPaint( super.getcolor() );  
			g2d.draw( new Ellipse2D.Double(super.getx1(), super.gety1(),super.getwidth(), super.getheight() ) );
		}
	} 
}