...
public class MyRhombus extends MyShape{
	public MyRhombus(  int x1, int y1, int x2, int y2,Color color,Color leftcolor,Color rightcolor, boolean filled ,int big){
	...
	public int getp3x( ){ return super.getx1( ) + ( super.getwidth ( ) /2 ) *1 ; }
	public int getp3y( ){ return super.gety2( ) ; }
	public int getp4x( ){ return super.getx2( ) ; }
	public int getp4y( ){ return super.gety1( ) + ( super.getheight( ) /2 ) *1 ; }
