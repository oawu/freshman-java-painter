...
public class MyPentagon extends MyShape{
	...
	public MyPentagon(  int x1, int y1, int x2, int y2,Color color,Color leftcolor,Color rightcolor, boolean filled ,int big){
		super(x1,y1,x2,y2,color,leftcolor,rightcolor,filled,big);
	}
	
	public int getp1x( ){ return super.getx1( ) + ( super.getwidth ( ) /2 ) *1 ; }
	...
	public int getp3x( ){ return super.getx1( ) + ( super.getwidth ( ) /4 ) *1 ; }
	public int getp3y( ){ return super.gety2( ) ; }
	public int getp4x( ){ return super.getx1( ) + ( super.getwidth ( ) /4 ) *3 ; }
	public int getp4y( ){ return super.gety2( ) ; }
	public int getp5x( ){ return super.getx2( ) ; }
	public int getp5y( ){ return super.gety1( ) + ( super.getheight( ) /3 ) *1 ; }
	...
	public void draw( Graphics g ){
		...
		if (  super.getisfilled() ){
			...
			g2d.draw( new Line2D.Double( getp5x(), getp5y(), getp1x(), getp1y() ));
		}
		else{
